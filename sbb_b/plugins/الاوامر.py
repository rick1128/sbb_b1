...
async def hi(event):
    await event.reply(
        "**قائـمه اوامر التمبلر:**\n\n• جميع هذه الاوامر تمبلر و اسماء مزخرفة\n ◂  `.رموز1`\n ◂  `.رموز2`\n ◂  `.تمبلريه `\n ◂  `.البايو`\n ◂  `.الاختصارات`\n ◂  `.اشهر مزغرفه`\n ◂  `.المواليد`\n ◂  `.اختصارات1`\n ◂  `.اختصارات2`\n ◂  `.اختصارات3`\n\n ◂  `.اختصارات4`\n ◂  `.اختصارات5`\n ◂  `.بايو1`\n ◂  `.بايو2`\n ◂  `.بايو3`\n\n ◂  `.بايو4`\n ◂  `.بايو5`\n ◂  `.بايوهات1`\n ◂  `.بايوهات2`\n ◂  `..`"
    )
    await event.delete()
